...
class Student
{
    ...
    private Student _prijatelj;

    public Student(string ime, string prezime, List<Ocjena> ocjene, Student prijatelj)
    {
        Ime = ime;
        Prezime = prezime;
        Ocjene = ocjene;
...
class Program
{
    static void Main(string[] args)
    {
        ...
        ocjene1.Add(new Ocjena(p1, 2));
        ocjene1.Add(new Ocjena(p2, 3));
        ocjene1.Add(new Ocjena(p3, 5));

        List<Ocjena> ocjene2 = new List<Ocjena>();
        ocjene2.Add(new Ocjena(p1, 3));
        ocjene2.Add(new Ocjena(p2, 4));
        ocjene2.Add(new Ocjena(p3, 4));

        Student s1 = new Student("Ivan", "Ivanic", ocjene1, null);
        Student s2 = new Student("Marko", "Maric", ocjene2, s1);
